	...
	return (
		<Nav.Menu 
			...
			<Nav.Menu title="Resources" openDirection="end">
				...
				<Nav.Item><Link to='/resources'>Blockchain and NFT</Link> </Nav.Item>
				<Nav.Item><Link to='/resources'>Enjoy showcase</Link></Nav.Item>
				<Nav.Item><Link to='/resources'>Earn passive incomes</Link></Nav.Item>
				<Nav.Item><Link to='/creation'>Creation process</Link></Nav.Item>
			</Nav.Menu>
			<Nav.Item>
